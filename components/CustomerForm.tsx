...
const numberFields = [
  "shoulder",
  // "sleeveLength",  // now string
  // "topLength",     // now string
  "chest",
  "tommy",
  "neck",
  "cufflinks",
      ...
      {!editable ? (
        ...
        <div className="space-y-6">
          ...
          <div>
            <p className="text-sm font-semibold opacity-70 mb-2">Measurements</p>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {[...numberFields, "sleeveLength", "topLength", "embroidery", "lengthWidth"].map((field) => (
                <div
                  key={String(field)}
                  className="p-3 bg-base-200 rounded-xl shadow-sm"
                >
        ...
        <div className="space-y-4 pt-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div className="form-control">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="input input-bordered w-full"
                  placeholder="e.g., 12/23/4"
                />
              </div>

              <div className="form-control">
                <label className="label">
                  <span className="label-text">Top Length</span>
                </label>
                <input
                  name="topLength"
          ...
          <div className="flex justify-end gap-2 pt-4">
            <button 
              ...
              className="btn btn-primary shadow-lg shadow-primary/25 hover:shadow-primary/40 hover:scale-105 transition-all duration-300 relative overflow-hidden group rounded-lg"
              style={{ borderRadius: '0.5rem !important' }}
            >
              <span className="absolute inset-0 bg-primary-focus opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg"></span>
