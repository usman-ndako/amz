...
// import { subscribeToDexieChanges, listenAndSyncFromFirestore, saveCustomer, deleteCustomerSync, syncLocalToFirestore } from "@/lib/sync";
...
//   const sortedCustomers = [...filteredCustomers].sort((a,b) => sortOrder==="newest" ? (b.timestamp||0)-(a.timestamp||0) : (a.timestamp||0)-(b.timestamp||0));
...
//       <div className="sticky top-0 z-10 bg-base-300/90 backdrop-blur-md shadow-md rounded-xl p-4 mb-6 flex justify-between items-center">
//         <div className="flex items-center gap-4">
//           <input type="text" placeholder="Search customers..." value={search} onChange={(e)=>setSearch(e.target.value)} className="input input-bordered w-full max-w-xs" />
...
//           setSelectedCustomer({ name:"",phone:"",address:"",top:"",shoulder:"",hand:"",burst:"",neck:"",trouser:"",length:"",waist:"",bmb:"",links:""});
...
//             <CustomerCard key={customer.id} customer={customer} onClick={()=>{
...
//                   <td>{customer.timestamp?new Date(customer.timestamp).toLocaleDateString():"-"}</td>
//                   <td><button className="btn btn-sm btn-outline" onClick={()=>{
//                     setSelectedCustomer(customer);
//                     (document.getElementById("detail_modal") as HTMLDialogElement)?.showModal();
//                   }}>View</button></td>
//                 </tr>
...
//           {selectedCustomer && <CustomerForm initialData={selectedCustomer} onSave={handleSaveCustomer} onDelete={handleDeleteCustomer} isNew={false}/>}
//           <div className="modal-action"><button className="btn" onClick={closeModals}>Close</button></div>
//         </div>
//       </dialog>
//     </main>
...
//     // ✅ Close immediately even offline
//     closeModals();
//   };
